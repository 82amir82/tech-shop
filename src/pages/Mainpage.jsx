...
const Mainpage = () => {
  ...
  //------------------------------------
   // const product = [...listproduct].sort((a,b)=>b.Discount - a.Discount);
    // const sales = [...listproduct].sort((a,b)=>b.SalesCount - a.SalesCount);
  ...
  return (
    <div className={style.parent}>
      ...
      <div className={style.headertakhfif}>
        ...
        <Link to={"/product?sort=1"}>مشاهده همه</Link>
      </div>
      ...
      <div className={style.headertakhfif}>
        ...
        <Link to={"/product?sort=4"}>مشاهده همه</Link>
      </div>
      <div className={style.dtakhfif}>
